...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`relative ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '200ms' }}>
              <div className="relative">
                {/* Main Card */}
                <div className="card card-glass p-8 relative z-10">
                  ...
                  <div className="mt-6 space-y-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600">Cardiologist • 15 years exp.</div>
                      </div>
                    </div>
                ...
                {/* Floating Elements */}
                <div className="absolute -top-6 -right-6 w-32 h-32 bg-blue-200 rounded-full blur-3xl opacity-50 animate-pulse"></div>
                <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-purple-200 rounded-full blur-3xl opacity-50 animate-pulse" style={{ animationDelay: '1s' }}></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              Why Choose <span className="text-gradient">MediConnect</span>
            </h2>
            ...
            {[
              {
                ...
                description: 'Crystal clear video calls with secure, HIPAA-compliant technology',
                color: 'blue'
              },
              {
                icon: (
                ...
                description: 'Access healthcare professionals anytime, anywhere, day or night',
                color: 'green'
              },
              {
                icon: (
              ...
              },
              {
                ...
                description: 'Receive e-prescriptions instantly and track your medications',
                color: 'pink'
              },
              {
                icon: (
                ...
                description: 'All your medical history in one secure, accessible place',
                color: 'orange'
              },
              {
                icon: (
                ...
                description: 'Transparent pricing with no hidden fees or surprise bills',
                color: 'teal'
              }
            ].map((feature, index) => (
              <div
      ...
      {/* How It Works */}
      <section id="how-it-works" className="py-20 px-4 sm:px-6 lg:px-8 gradient-medical">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                step: '02',
                title: 'Choose Doctor',
                description: 'Browse profiles and select a specialist that fits your needs'
              },
              {
                step: '03',
                title: 'Start Consultation',
                description: 'Connect instantly via video call and get expert medical advice'
              }
            ].map((step, index) => (
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button
            onClick={() => router.push('/auth')}
            className="btn btn-lg bg-white text-blue-600 hover:bg-gray-100 shadow-xl"
          >
            Get Started Free
          </button>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm">
                Connecting patients with healthcare professionals through secure video consultations.
              </p>
            </div>
